namespace Models
{
    ...
    public class QuarterlyReportCashflow
    {
        public string fiscalDateEnding { get; set; }
        public string reportedCurrency { get; set; }
        public string operatingCashflow { get; set; }
    ...
    public class CashFlow
    {
        ...
        public List<AnnualReportCashflow> annualReports { get; set; }
        public List<QuarterlyReportCashflow> quarterlyReports { get; set; }
    }
}